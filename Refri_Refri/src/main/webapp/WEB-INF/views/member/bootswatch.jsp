          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="download">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="../lumen/bootstrap.min.css" download="">bootstrap.min.css</a>
                <a class="dropdown-item" href="../lumen/bootstrap.css" download="">bootstrap.css</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="../lumen/_variables.scss" download="">_variables.scss</a>
                <a class="dropdown-item" href="../lumen/_bootswatch.scss" download="">_bootswatch.scss</a>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div class="page-header" id="banner">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 col-sm-6">
            <div class="sponsor">
              <script async="" src="https://cdn.carbonads.com/carbon.js?serve=CKYIE23N&amp;placement=bootswatchcom" id="_carbonads_js"></script><div id="carbonads"><span><span class="carbon-wrap"><a href="https://srv.carbonads.net/ads/click/x/GTND42JWCTAD62J7CESLYKQNCEYD5KQNFT7DLZ3JCYBDT27ECE7I5K3KCEBD6KJ7CYYDT2JJCYYDL5QICWYD62QKC6SDVK3YCWBDEK3EHJNCLSIZ?segment=placement:bootswatchcom;" class="carbon-img" target="_blank" rel="noopener sponsored"><img src="https://cdn4.buysellads.net/uu/1/3386/1525189943-38523.png" alt="ads via Carbon" border="0" height="100" width="130" style="max-width: 130px;"></a><a href="https://srv.carbonads.net/ads/click/x/GTND42JWCTAD62J7CESLYKQNCEYD5KQNFT7DLZ3JCYBDT27ECE7I5K3KCEBD6KJ7CYYDT2JJCYYDL5QICWYD62QKC6SDVK3YCWBDEK3EHJNCLSIZ?segment=placement:bootswatchcom;" class="carbon-text" target="_blank" rel="noopener sponsored">Limited time offer: Get 10 free Adobe Stock images.</a></span><a href="http://carbonads.net/?utm_source=bootswatchcom&amp;utm_medium=ad_via_link&amp;utm_campaign=in_unit&amp;utm_term=carbon" class="carbon-poweredby" target="_blank" rel="noopener sponsored">ads via Carbon</a></span></div>
            </div>
          </div>
        </div>
      </div>
